 /*
 * @author Tushar Chouhan <tushar.chauhan94@utexas.edu>
 */
...
struct index_cal {
int **b;int **index_mat;int n;int *finpar;int **size; int numThreads;
void operator ()(int i){
int xx,j;
 for(j=0;j<n;j++)
 {
...
struct fin_merge {
int **b;int **bb;int **size;int **sum;int **index_mat;int n; int numThreads;
void operator ()(int i){
int xx=0,j;
...
struct gathersplit{
int* gath; int **b;int n;int p; int numThreads;
void operator () (int i){
	int j;int x=0;
